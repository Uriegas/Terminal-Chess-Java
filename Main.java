public class Main {
    public static void main(String[] args) {
		...
		//Agrega las Reinas
		board.setPiece("\033[;31m" + String.valueOf(queen.toChar()) + "\033[;37m", 0, 3);
		board.setPiece("\033[;34m" + String.valueOf(queen.toChar()) + "\033[;37m", 7, 3);
		...
		for(int i = 0; i < board.getFilas(); i++)
		{
			for(int j = 0; j < board.getColumnas(); j++)
			{
				...
				if(i == 1){
					board.setPiece("\033[;31m" + String.valueOf(pawn.toChar()) + "\033[;37m" , i, j);
					//board.setPiece(String.valueOf(pawn.toChar()), i, j);
				}else if(i == 6){
					board.setPiece("\033[;34m" + String.valueOf(pawn.toChar()) + "\033[;37m", i, j);
